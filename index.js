...
form.addEventListener('submit', (event) => {
  ...
  axios
    .post('https://crudcrud.com/api/3adeeb8a14d74b278df06ff244b1fec9/ToDo', obj)
    .then((result) => {
      incompleteToDos(obj);
      alert('Todo added');
    })
...
window.addEventListener('DOMContentLoaded', () => {
  axios
    .get('https://crudcrud.com/api/3adeeb8a14d74b278df06ff244b1fec9/ToDo')
    .then((result) => {
...
function incompleteToDos(obj) {
  ...
  doneBtn.addEventListener('click', () => {
    ...
    axios
      .put(
        `https://crudcrud.com/api/3adeeb8a14d74b278df06ff244b1fec9/ToDo/${obj._id}`,
        {
